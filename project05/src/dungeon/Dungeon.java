...
//    this.end = end;
  ...
  public boolean playerLocationHasArrows() {
    return this.grid[this.getPlayerLocation()[0]][this.getPlayerLocation()[1]].getNumberOfArrows() != 0;
  }

  @Override
  public boolean playerLocationHasTreasure() {
    return !this.grid[this.getPlayerLocation()[0]][this.getPlayerLocation()[1]].getTreasures().isEmpty();
  }
