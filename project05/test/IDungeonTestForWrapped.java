...
public class IDungeonTestForWrapped {
  ...
  public void setUp() {
    dungeon = new Dungeon(2,
            "Ben", true, 6, 8, 20, 4, new MockRandomnessForWrappedWithMonsters());
  }
  ...
  public void testShootWhenCorrectDistanceAndDirectionSpecified() {
    ...
    assertEquals(expectedPlayerDescription, dungeon.getPlayerDescription());
    //kill nearby monster
    assertTrue(dungeon.shoot(1, Direction.WEST));
    assertTrue(dungeon.shoot(1, Direction.WEST));
  ...
  public void testShootWhenPlayerHasNoMoreArrows() {
    ...
    //kill nearby monster
    assertFalse(dungeon.shoot(1, Direction.WEST));
    assertFalse(dungeon.shoot(1, Direction.WEST));
  ...
  public void testShootWhenArrowPassesThroughACrookedTunnel() {
    ...
    assertEquals(expectedPlayerDescription, dungeon.getPlayerDescription());
    //kill nearby monster
    assertTrue(dungeon.shoot(1, Direction.NORTH));
    assertTrue(dungeon.shoot(1, Direction.NORTH));
  ...
  public void testShootShouldTakeInAnExactDistance() {
    ...
    assertFalse(dungeon.shoot(2, Direction.NORTH));
    assertFalse(dungeon.shoot(2, Direction.NORTH));
  ...
  public void testShootIfArrowIsNotAbleToCompleteDistance() {
    ...
    assertFalse(dungeon.shoot(1, Direction.NORTH));
    assertFalse(dungeon.shoot(1, Direction.NORTH));
