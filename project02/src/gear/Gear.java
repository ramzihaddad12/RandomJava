...
public interface Gear extends Comparable<Gear> {
  ...
  /**
   * A method that gets the size for the gear.
   * @return the size for the gear
   */

  public Size getSize();

  /**
   * A method that gets the attribute(s) to effect for the gear.
   * @return the attribute(s) to effect for the gear
   */
