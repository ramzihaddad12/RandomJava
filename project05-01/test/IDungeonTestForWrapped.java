...
public class IDungeonTestForWrapped {
  ...
  public void setUp() {
    dungeon = new Dungeon(2,
            "Ben", true, 6, 8, 20, 4,
            0, new MockRandomnessForWrappedWithMonsters());
  }
  ...
  public void testDungeonConstructor() {
    int[] expectedLocation = new int[] {5, 2};
    ...
    String expectedRoomsDescription =
            ...
            +    " It has 1 entrances, and has 0 sapphires, 0 diamonds, 0 rubies, and 2 arrows."
            +    " The possible next locations are (->)\n"
            ...
            +    " It has 4 entrances, and has 0 sapphires, 0 diamonds, 0 rubies, and 0 arrows. "
            + "The possible next locations are (<-^v->)\n"
            ...
            + " It has 3 entrances, and has 0 sapphires, 1 diamonds, 0 rubies, and 0 arrows."
            + " The possible next locations are (<-^v)\n"
            + "The room is on row 4 and column 7 in the dungeon."
            + " It has 1 entrances, and has 1 sapphires, 0 diamonds, 0 rubies, and 0 arrows."
            + " The possible next locations are (^)\n"
    ...
    String expectedPlayerDescription = "Ben is in room (<-^v) which is at row 5, column 2. "
  ...
  public void
    ...
    Dungeon invalidDungeon = new Dungeon(0, "Ben", true, 6, 8,
            20, 50, 0, new Randomness());
  }

  /**
   * Tests the dungeon constructor when number of pits passed is greater
   * than the number of rooms - 2 in the dungeon.
   */

  @Test(expected = IllegalArgumentException.class)
  public void
      testDungeonConstructorWhenNumberOfPitsIsGreaterThanTheNumberOfRoomsMinus2InTheDungeon() {
    Dungeon invalidDungeon = new Dungeon(0, "Ben", true, 6, 8,
            20, 50,47, new Randomness());
  }

  /**
   * Tests the dungeon constructor when number of pits passed is
   * negative.
   */

  @Test(expected = IllegalArgumentException.class)
  public void
      testDungeonConstructorWhenNumberOfPitsIsNegative() {
    Dungeon invalidDungeon = new Dungeon(0, "Ben", true, 6, 8,
            20, 50,-1, new Randomness());
  }
   ...
   * wrapped dungeon and killing all monsters.
   */

  @Test
  public void testMovePlayerToVisitAllRoomsAndKillAllMonstersForWrappedDungeon() {
    int[] expectedLocation = new int[] {5, 2};
    assertTrue(Arrays.equals(expectedLocation,dungeon.getPlayerLocation()));
    ...
    //kill nearby monster
    dungeon.shoot(2, Direction.SOUTH);
    dungeon.shoot(2, Direction.SOUTH);
  ...
  public void testPickUpTreasureWhenTreasureIsPresentInRoom() {
    ...
    expectedPlayerDescription = "Ben is in room (v) which is at row 2, column 1."
            + " The room is a tunnel : false."
  ...
  public void testCurrentRoomDescriptionWhenTreasureIsNotPickedUpInRoom() {
    ...
    String expectedRoomDescription =
            "The room is on row 5 and column 2 in the dungeon. It has 3 entrances,"
            + " and has 0 sapphires, 0 diamonds, 0 rubies, and 1 arrows. "
            + "The possible next locations are (<-^v)";
  ...
  public void testCurrentRoomDescriptionWhenTreasureIsPickedUpInRoom() {
    ...
    String expectedRoomDescription =
            "The room is on row 2 and column 1 in the dungeon. It has 1 entrances, "
  ...
  public void testPickUpArrowsWhenArrowsNotPresentInRoom() {
    ...
    String expectedPlayerDescription = "Ben is in room (->) which is at row 5, column 1. "
            + "The room is a tunnel : false. "
            + "Player has 0 sapphires, 0 diamonds, 0 rubies, and 3 arrows."
            + " The player smells a NO_SMELL"
            + ". The player is in danger of falling: false";
  ...
  /**
   * Tests the currentRoomDescription method when arrows picked up in room.
   */
  ...
  public void testShootWhenCorrectDistanceAndDirectionSpecified() {
    ...
    String expectedPlayerDescription =
            "Ben is in room (<-v) which is at row 1, column 0. "
    ...
    assertEquals(expectedPlayerDescription, dungeon.getPlayerDescription());
    //kill nearby monster
    assertEquals(0, dungeon.shoot(1, Direction.WEST));
    assertEquals(1, dungeon.shoot(1, Direction.WEST));

    assertEquals(expectedNumberOfMonsters - 1, dungeon.getNumberOfMonsters());

    expectedPlayerDescription = "Ben is in room (<-v) which is at row 1, column 0. "
            + "The room is a tunnel : true. "
            + "Player has 0 sapphires, 0 diamonds, 0 rubies, and 4 arrows."
            + " The player smells a NO_SMELL"
            + ". The player is in danger of falling: false";
  ...
  public void testShootWhenPlayerHasNoMoreArrows() {
    ...
    expectedPlayerDescription = "Ben is in room (<-^v) which is at row 5, column 2."
            + " The room is a tunnel : false."
  ...
  public void testShootWhenArrowPassesThroughACrookedTunnel() {
    ...
    String expectedPlayerDescription = "Ben is in room (<-^) which is at row 2, column 0. "
            + "The room is a tunnel : true. "
            + "Player has 0 sapphires, 0 diamonds, 0 rubies, and 6 arrows."
    ...
    expectedPlayerDescription = "Ben is in room (<-^) which is at row 2, column 0. "
            + "The room is a tunnel : true. "
            + "Player has 0 sapphires, 0 diamonds, 0 rubies, and 4 arrows."
            + " The player smells a NO_SMELL"
            + ". The player is in danger of falling: false";
  ...
  public void testWhenSmellIsPungent() {
    ...
    dungeon.movePlayer(Direction.NORTH);
    dungeon.movePlayer(Direction.EAST);
    String expectedDescription = "Ben is in room (<-^) which is at row 2, column 0. "
            + "The room is a tunnel : true. "
            + "Player has 0 sapphires, 0 diamonds, 0 rubies, and 3 arrows."
            + " The player smells a PUNGENT"
            + ". The player is in danger of falling: false";
  ...
  /**
   * Tests the getVisitedLocations method.
   */
  @Test
  public void testGetVisitedLocations() {
    boolean[][] expected = new boolean[6][8];
    expected[dungeon.getStart()[0]][dungeon.getStart()[1]] = true;
    dungeon.movePlayer(Direction.NORTH);
    int[] expectedLocation = new int[] {4, 2};
    expected[expectedLocation[0]][expectedLocation[1]] = true;
    assertTrue(Arrays.equals(expectedLocation,dungeon.getPlayerLocation()));
    ...
    assertEquals(expected, dungeon.getVisitedLocations());
  }

  /**
   * Tests the getDungeon method.
   */
  @Test
  public void testGetDungeon() {
    IDungeon sameDungeon = new Dungeon(2,
            "Ben", true, 6, 8, 20, 4,
            0,new MockRandomnessForWrappedWithMonsters());

    for (int i = 0; i < 6; i++) {
      for (int j = 0; j < 8; j++) {
        assertEquals(sameDungeon.getDungeon()[i][j].getDescription(),
                dungeon.getDungeon()[i][j].getDescription());
      }
    }
  }

  /**
   * Tests the clearDungeon method.
   */

  @Test
  public void testClearDungeon() {
    boolean[][] expected = new boolean[6][8];
    expected[dungeon.getStart()[0]][dungeon.getStart()[1]] = true;
    int[] expectedLocation = new int[] {5, 2};
    assertTrue(Arrays.equals(expectedLocation,dungeon.getPlayerLocation()));
    ...
    expected = new boolean[6][8];
    expected[dungeon.getStart()[0]][dungeon.getStart()[1]] = true;

    assertEquals(expected, dungeon.getVisitedLocations());
    assertTrue(Arrays.equals(dungeon.getStart(), dungeon.getPlayerLocation()));
    assertTrue(dungeon.getPlayerDescription().contains("0 sapphires, 0 diamonds,"
            + " 0 rubies, and 3 arrows"));
  }

  /**
   * Tests the didPlayerFallInPit method.
   */

  @Test
  public void testDidPlayerFallInPit() {
    dungeon.movePlayer(Direction.SOUTH);
    assertFalse(dungeon.didPlayerFallInPit());
  ...
  /**
   * Tests the didPlayerGetRobbed method.
   */

  @Test
  public void testDidPlayerGetRobbed() {
    assertFalse(dungeon.didPlayerGetRobbed());
    ...
    dungeon.movePlayer(Direction.SOUTH);
    assertTrue(dungeon.didPlayerGetRobbed());
  }

  /**
   * A test for the getNumberOfPits method.
   */

  @Test
  public void testGetNumberOfPits() {
    assertEquals(0, dungeon.getNumberOfPits());
  }
}
