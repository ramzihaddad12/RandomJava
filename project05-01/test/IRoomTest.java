...
public class IRoomTest {
  ...
  /**
   * Tests the roomHasTreasure method when it has treasure.
   */

  @Test
  public void testRoomHasTreasureWhenItDoes() {
    List<Treasure> treasures = new ArrayList<>();
    treasures.add(Treasure.SAPPHIRE);
    room.addTreasures(treasures);
    assertTrue(room.roomHasTreasure());
  }

  /**
   * Tests the roomHasArrow method when it has no treasure.
   */

  @Test
  public void testRoomHasTreasureWhenItDoesNot() {
    assertFalse(room.roomHasTreasure());
  }

  /**
   * Tests the roomHasTreasure method when it has arrows.
   */

  @Test
  public void testRoomHasArrowWhenItDoes() {
    room.addArrows(1);
    assertTrue(room.roomHasArrow());

  }

  /**
   * Tests the roomHasArrow method when it has no arrow.
   */

  @Test
  public void testRoomHasArrowWhenItDoesNot() {
    assertFalse(room.roomHasArrow());
  }

  /**
   * Tests the hasPit method.
   */
  ...
  /**
   * Tests the hasThief method.
   */

  @Test
  public void testHasThief() {
    assertFalse(room.hasThief());

    room.addThief();
    assertTrue(room.hasThief());
  }

  /**
   * Tests the addThief method.
   */
