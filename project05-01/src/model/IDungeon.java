...
public interface IDungeon {
   ...
   * @return 1 if the monster is killed, 0 if
   *          the monster has been hit, and -1 if no monster was hit.
   */
  ...
  /**
   * Gets the visited locations of the player in the dungeon.
   * @return a boolean 2d-array that represents the
   *          visited locations of the player in the dungeon.
   */
  public boolean[][] getVisitedLocations();

  /**
   * Gets the dungeon as a 2d grid.
   * @return the dungeon as 2d grid.
   */
  public IRoom[][] getDungeon();

  /**
   * Clears the dungeon, and re-initializes the dungeon
   * to its initial state.
   */
  public void clearDungeon();

  /**
   * Checks if the player fell in a pit.
   * @return whether if the player fell in a pit.
   */

  public boolean didPlayerFallInPit();

  /**
   * Checks if the player got robbed.
   * @return whether if the player got robbed.
   */

  public boolean didPlayerGetRobbed();

  /**
   * Gets the number of pits present in the dungeon.
   * @return the number of pits present in the dungeon.
   */
