 ...
 * that can move, shoot, and pick up items
 * such as treasure and arrows.
 */
...
public interface IPlayer {
  ...
  /**
   * Checks if the player is in danger, meaning
   * that there is a pit nearby.
   * @return whether if the player is in danger, meaning
   *        that there is a pit nearby.
   */
  ...
  /**
   * Removes all the treasures the player has.
   */
