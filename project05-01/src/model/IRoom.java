 ...
 * that may contain treasure, arrows, monsters, or pits.
 */
...
public interface IRoom {
  ...
  /**
   * Checks whether the room has treasure in it or not.
   * @return whether the room has treasure in it or not.
   */
  public boolean roomHasTreasure();

  /**
   * Checks whether the room has arrows in it or not.
   * @return whether the room has arrows in it or not.
   */
   ...
   * @return whether the room has a thief.
   */

  public boolean hasThief();

  /**
   * Adds a thief the room.
   */
