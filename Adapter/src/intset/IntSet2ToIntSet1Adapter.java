...
/**
 * Adapts an {@link IntSet2} to the {@link IntSet1} interface. The is the object
 * adapter pattern.
 */
public final class IntSet2ToIntSet1Adapter implements IntSet1, IntSet2 {
   ...
   * 
   * @param adaptee the initial set
   */
  public IntSet2ToIntSet1Adapter(IntSet2 adaptee) {
    Objects.requireNonNull(adaptee);
    this.adaptee = IntSet2Impl.empty();
    this.adaptee.unionWith(adaptee);
  }
