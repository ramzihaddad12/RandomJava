...
/**
 * Interface for simple sets of integers. An alternative approach.
 */
public interface IntSet2 {
  ...
  /**
   * The contents of the set as a list of integers. Modifying the returned list
   * will have no effect on this set.
   * 
