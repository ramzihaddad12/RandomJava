...
public class DriverForWrappedVisitAllLocations {
  /**
  ...
  public static void main(String[] args) {
    ...
    Dungeon dungeon = new Dungeon(2, "player", true, 6, 8, 20, new MockRandomnessForWrapped());
    ...
    System.out.println(dungeon.getRoomsDescription());
    System.out.println("*************");
    System.out.println();
    ...
    System.out.println("Player has reached end! Hurray!"
            + " Player has also visited all rooms in the dungeon");
  }
}
