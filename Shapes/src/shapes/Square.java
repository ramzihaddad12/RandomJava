...
public class Square extends Rectangle {
   ...
   * @param side the initial length of the side
   */
  ...
  public String toString() {
    return String.format("Square: LL corner (%.3f,%.3f) side %.3f", this.reference.getX(),
        this.reference.getY(), this.width);
  }

  @Override
  protected boolean equalsSquare(Square other) {
    return this.reference.equals(other.reference) && Math.abs(this.width - other.width) < 0.001
   ...
   * @return true if other is equal to current shape
   */
