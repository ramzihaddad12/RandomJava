...
public class SimpleTurtle implements TurtleModel {
  ...
  private Stack<Position2D> stackPositions;
  private Stack<Double> stackHeadings;

  /**
   * Initializes the turtle to the default state. Default state = position (0,0)
   * and heading (0) meaning looking in the +X direction.
   */
  public SimpleTurtle() {
    this(new Position2D(0, 0), 0); // call the other constructor
  }
  ...
  public Position2D getPosition() {
    // okay to just return this object because it is immutable
    return position;
  }
