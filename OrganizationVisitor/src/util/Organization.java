...
public interface Organization {
   ...
   * @param supervisorName the name of the supervisor. The supervisor should be
   *                       an existing employee
   */
  void addEmployee(String name, double pay, Gender gender,
   ...
   *                       an existing employee
   */
  void addContractEmployee(String name, double pay, Gender gender, int endDate,
